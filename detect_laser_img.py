...
print(len(coord))
print(skel_coords[1][0] - skel_coords[0][0])
print(coord[0][0][0])

print(res_blue.shape)

for i in range(skel_coords[0][0], skel_coords[1][0]-2):
    #print(i)
    for j in range(0, coord[i][0][0]):
        #print(i, j, coord[i][0][0])
        res_blue[i,j] = [255, 0, 0]

cv2.imshow('res_blue2', res_blue)
